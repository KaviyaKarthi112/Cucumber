...
//	}
	//Screenshot Method
		public static void screenShot(String name) {
			...
			File destfile = new File("F:\\Software\\java\\Cucumber\\Screenshot"+name+".png");
...
public void sendkeys(By name,String text) {
...
//	file =new File("F:\\Software\\java\\Testng\\Reports");
//	ExtentSparkReporter sparkReporter =  new ExtentSparkReporter(file);
//	extentReports.attachReporter(sparkReporter);
//}
//public void extendReportTearDown() throws IOException {
//	extentReports.flush();
//	file = new File("F:\\Software\\java\\Testng\\Reports\\Index.html");
